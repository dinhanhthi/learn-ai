...
- [ ] **[Advanced Statistics for Data Science Specificaton](https://www.coursera.org/programs/add9daf8-77cf-4389-b6e7-39416bfd8761/browse?currentTab=MY_COURSES&productId=TLdRZuEQEeqkDRL_pYf3Gw&productType=s12n&query=statistics+for+data+science&showMiniModal=true)**  by Johns Hopkins University on Coursera.
...
- [x] **[Deep Learning Specialization](https://www.coursera.org/specializations/deep-learning)** by Andrew NG on Coursera. It contains 5 courses covering the foundations of Deep Learning (CNN, RNN, LSTM, Adam, Dropout, BatchNorm, Xavier/He initialization,...). Many case studies projects are proposed — [my note](https://dinhanhthi.com/tags#deeplearning-ai) -- [my certificate](https://github.com/dinhanhthi/my-certificates/blob/e0e96f01e43d42a5de84515a95f91bf145967032/deeplearning.ai%20-%20deep%20learning%20spec/Coursera%20Deep%20Learning%20by%20Andrew%20NG.pdf).
